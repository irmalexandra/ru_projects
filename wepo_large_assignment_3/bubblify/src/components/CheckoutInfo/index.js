...
class CheckoutInfo extends React.Component {
    ...
    checkoutHandler = () => {
        this.setState({isDelivery: document.getElementById("delivery").checked})
    }
                            ...
                            <div>
                                ...
                                <form onSubmit={(e) => this.validateForm(e)}>
                                    <div className="form-group">
                                        ...
                                        <small id="nameHelp" className="form-text text-muted mb-4">We hope you will
                                            share your
                                            name with
                                            us</small>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input type="text" ref={input => this.userForm.address = input}
                                               ...
                                               onInput={e => this.onInput(e)}/>
                                        <small id="addressHelp" className="form-text text-muted mb-4">Your address is
                                            very
                                            important so
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" ref={input => this.userForm.city = input}
                                               ...
                                               onInput={e => this.onInput(e)}/>
                                        <small id="cityHelp" className="form-text text-muted mb-4">What is a city
                                            without
                                            bubbles in
                                            it?</small>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input type="text" ref={input => this.userForm.telephone = input}
                                               ...
                                               onInput={e => this.onInput(e)}/>
                                        <small id="telephoneHelp" className="form-text text-muted mb-4">So we can call
                                            you for
                                            all your
                                            bubble needs</small>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input type="text" ref={input => this.userForm.postalCode = input}
                                               ...
                                               onInput={e => this.onInput(e)}/>
                                        <small id="postalCodeHelp" className="form-text text-muted mb-4">We couldn't
                                            come up
                                            with
